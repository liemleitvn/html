        ...
        <div class="wrapper">
            ...
            <form action="#" method="get">
                <div class="search-field">
                    <input type="text" id="check-in-date" name="check_in_date" placeholder="Check in date">
                    <hr class="field_sep float">
                    <input type="text" id="check-out-date" name="check_out_date" placeholder="Check out date">
                </div>
                <div class="search-field">
                    <input type="text" id="min-price" placeholder="Min price" name="min_price" >
                    <hr class="field_sep float">
                    <input type="text" id="max-price" placeholder="Max price" name="max_price">
                </div>
                <div>
